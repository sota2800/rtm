...
class facedetectiondata_i (Library__POA.facedetectiondata):
    """
    ...
    # Dataset facedetection(in Dataset data)
    def facedetection(self, data):
        raise CORBA.NO_IMPLEMENT(0, CORBA.COMPLETED_NO)
        # *** Implement me
        # Must return: result

    # Dataset waitefacedetection(in Dataset data)
    def waitefacedetection(self, data):
        raise CORBA.NO_IMPLEMENT(0, CORBA.COMPLETED_NO)
        # *** Implement me
        # Must return: result

    # Dataset facedetectionadditionalfunction(in Dataset data)
    def facedetectionadditionalfunction(self, data):
        raise CORBA.NO_IMPLEMENT(0, CORBA.COMPLETED_NO)
        # *** Implement me
        # Must return: result
