...
class selectTest(OpenRTM_aist.DataFlowComponentBase):
    ...
    def __init__(self, manager):
        ...
        """
        """
        self._selectprovider = OpenRTM_aist.CorbaConsumer(interfaceType=Library.selectdata)
    ...
    def onInitialize(self):
        ...
        self._selectproviderPort.registerConsumer("selectdata", "Library::selectdata", self._selectprovider)
